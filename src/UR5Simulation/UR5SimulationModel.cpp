...
UR5::UR5()
 : RobotDynamicsRnea(),
  tau(Vector(UR5DOF)),
  fric(Vector(UR5DOF)),
  baseParmSet1(Vector(baseParamSet1Size)),
  baseParmSet2(Vector(baseParamSet2Size)),
  jacobian(Matrix::Zero(6, UR5DOF)),
  forceTransformMatrix(Matrix::Zero(6,6))
{
    tau.setZero();
    fric.setZero();
...
void UR5::initBaseParameterSet()
{
    ...
    baseParmSet1 << -2.334294255, 1.483681688, 8.85E-05, -0.253187693, -0.013157858, -1.499552237,
        3.516911842, -0.007208486, 0.766222431, -0.011079468, -0.107262405, 0.040178292,
        -0.778106928, 1.970331238, -0.00382015, -0.044352643, 0.011754601, 0.001912371,
        -0.052642479, 0.014188733, -0.002872881, 0.231991236, -0.026056392, -0.014956514,
        0.026087888, -0.03798613, -0.061489771, 0.001301895, -0.091755516, 0.028256136,
        -0.000891333, -0.011801835, 0.014612743, -0.029182398, -0.004179365, -0.003074451,
        0.035369162, -0.038082289, 0.0423764, -0.011739182;
