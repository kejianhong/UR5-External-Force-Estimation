...
// 构造函数
FilterDynObserverRnea::FilterDynObserverRnea(RobotDynamicsRnea* rd, double cutOff, double sampTime):
ExternalObserverRnea(rd, ID_FilterDynObserverRnea),
f1(FilterF1(cutOff, sampTime, jointNo)),
f2(FilterF2(cutOff, sampTime, jointNo)),
p(Vector(jointNo)),
tauExt(Vector(jointNo)),
